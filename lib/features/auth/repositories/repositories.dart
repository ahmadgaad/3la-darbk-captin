...
class AuthRepositoryImpl implements AuthRepository {
 ...
 final ApiClient _apiClient;
  ...
  Future<Either<void, AppException>> login(
    ...
    try {
      final response = await _apiClient.post(
          ...
          data: {"mobile": mobile, "password": password},showErrorMessage: false);
  ...
  Future<Either<bool, AppException>> checkUserExists(
    ...
    try {
      await _apiClient.post(
          endPoint: ApiEndPoints.checkUserExists, data: {"mobile": mobile},
  ...
  Future<Either<UserModel, AppException>> updateData(UserModel user) async {
    try {
      final response = await _apiClient.post(
          endPoint: ApiEndPoints.updateDriver, data: user.toJson());
      final userModel = UserModel.fromJson(response.data ?? {});
      return Left(userModel);
    } on AppException catch (e) {
      return Right(e);
